 ...
 Threebox.prototype = {
	 ...
	 getIteratedSelectionIndex(intersects) {
		 ...
		 if(this.utils.arrayShallowEqual(this.intersectionStack, intersectedObjects))
		 {
			 ...
			 console.log("no shallow equal");
			 this.intersectionStack = intersectedObjects;
			 console.log("selected object", this.map.selectedObject);
		 ...
		 console.log(this.intersectionStack, intersectedObjects);
		 console.log('selectionRotationIndex', this.selectionRotationIndex);
