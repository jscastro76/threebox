...
Objects.prototype = {
  ...
  _addMethods: function (obj, isStatic, objects) {
    ...
    if (isStatic) {
      ...
      // Bestow this mesh with animation superpowers and keeps track of its movements in the global animation queue
      objects.animationManager.enroll(obj);
      ...
      obj.setRotationAxis = function (xyz) {
        ...
        if (xyz.x != 0)
          _applyAxisAngle(obj, point, new THREE.Vector3(0, 0, 1), xyz.x);
        if (xyz.y != 0)
          _applyAxisAngle(obj, point, new THREE.Vector3(0, 0, 1), xyz.y);
        if (xyz.z != 0)
          _applyAxisAngle(obj, point, new THREE.Vector3(0, 0, 1), xyz.z);
      };
      ...
      obj.drawBoundingBox = function () {
        ...
        let boxModel = new THREE.Box3Helper(
          bb,
          Objects.prototype._defaults.colors.yellow
        );
        ...
        bb2.max.z = bb2.min.z;
        let boxShadow = new THREE.Box3Helper(
          bb2,
          Objects.prototype._defaults.colors.black
        );
      ...
      obj.drawLabelHTML = function (
        HTMLElement,
        visible = false,
        center = obj.anchor,
        height = 0.5
      ) {
        let divLabel = root.drawLabelHTML(
          HTMLElement,
          Objects.prototype._defaults.label.cssClass
        );
      ...
      obj.addCSS2D = function (
        ...
        if (element) {
          ...
          c.name = objName;
          c.position.set(
            -size.x * 0.5 - obj.model.position.x - center.x + bottomLeft.x,
            -size.y * 0.5 - obj.model.position.y - center.y + bottomLeft.y,
            size.z * height
          );
      ...
      Object.defineProperty(obj, "selected", {
        ...
        set(value) {
          if (value) {
            ...
            if (obj.boxGroup) {
              obj.boundingBox.material =
                Objects.prototype._defaults.materials.boxSelectedMaterial;
        ...
        set(value) {
          if (value) {
            if (!obj.selected) {
              ...
              if (obj.boxGroup) {
                obj.boundingBox.material =
                  Objects.prototype._defaults.materials.boxOverMaterial;
                obj.boundingBox.parent.visible = true;
                obj.boundingBox.layers.enable(1);
                obj.boundingBoxShadow.layers.enable(1);
              }
      ...
      Object.defineProperty(obj, "unitsPerMeter", {
        get() {
          return Number(
            utils.projectedUnitsPerMeter(obj.coordinates[1]).toFixed(7)
          );
        },
      });
