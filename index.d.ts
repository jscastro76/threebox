...
declare module "threebox-plugin" {
  export interface IThreeboxConfiguration {
  ...
  export interface IObjectAddOptions {
    layerId: number;
    sourceId: number;
  }

  export type AzimuthAltitude = [number, number];

  export class Object {}

  export interface RequiredObjectOption {
    type: "mtl" | "gltf" | "fbx" | "dae";
    obj: string;
  }

  export interface OptionalObjectOption extends RequiredObjectOption {
    mtl: string;
    bin: string;
    units: "scene" | "meters";
